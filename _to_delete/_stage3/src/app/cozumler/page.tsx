  ...
  return (
    <>
      ...
      <section className="py-20">
        <Container>
          <div className="flex flex-col items-center justify-between gap-6 rounded-2xl border border-brand-100 bg-brand-50 px-8 py-10 text-center sm:flex-row sm:text-left">
            <div>
