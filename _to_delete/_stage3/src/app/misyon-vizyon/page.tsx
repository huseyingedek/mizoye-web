      ...
      <section className="py-16 sm:py-20">
        <Container>
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="relative overflow-hidden rounded-2xl border border-brand-100 bg-gradient-to-br from-brand-50 to-white p-9">
            ...
            <div className="relative overflow-hidden rounded-2xl border border-accent-500/20 bg-gradient-to-br from-accent-400/10 to-white p-9">
        ...
        <Container>
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-3">
            {t.mission.slogans.map((slogan, i) => (
              ...
              >
                <span className="absolute -top-2 left-5 text-6xl font-serif leading-none text-brand-100">
                  “
                </span>
