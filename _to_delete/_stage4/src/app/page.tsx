...
import { HeroArt, DotGrid } from "@/components/Illustrations";
        ...
        <Container className="relative py-16 sm:py-20 lg:py-24">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div className="relative">
              <DotGrid className="pointer-events-none absolute -right-4 -top-6 hidden text-brand-200/70 sm:block" />
              <HeroArt className="animate-fade-up relative w-full" />
            </div>
          </div>
      ...
      <section className="pb-24">
        <Container>
          <Reveal className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-brand-700 to-navy-900 px-8 py-14 text-center sm:px-16 sm:py-20">
            <DotGrid className="pointer-events-none absolute right-6 top-6 text-white/10" />
