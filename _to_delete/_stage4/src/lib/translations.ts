...
export const translations = {
  tr: {
    ...
    home: {
      ...
      ctaSecondary: "Yazılımlarımızı Keşfedin",
      stats: [
  ...
  en: {
    ...
    home: {
      ...
      ctaSecondary: "Explore Our Software",
      stats: [
